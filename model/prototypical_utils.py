...
def compute_prototypical_loss(inputs, labels, support_num): 
    ...
    # compute the distance between each query point and each barycentre, use negative value as scores (so the larger equals to the better) They only assign class that in the support samples
